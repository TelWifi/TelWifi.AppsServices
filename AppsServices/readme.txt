 ...
 This will deploy two artifacts, target/AppsServices.war and
 default-ds.xml.
 ...
 - http://localhost:8080/AppsServices/
 ...
 Now you can either deploy the target/AppsServices.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/AppsServices.war

 To undeploy the application, run:

  ./asadmin undeploy AppsServices
